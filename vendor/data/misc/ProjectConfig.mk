...
CUSTOM_HAL_IMGSENSOR = s5kgm1stofilm_mipi_raw s5k3l6ofilm_mipi_raw ov02b10ofilm_mipi_raw hi259ofilm_mipi_raw ov8856ofilm_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = ov02b10ofilm_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1stofilm_mipi_raw
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = s5k3l6ofilm_mipi_raw
CUSTOM_HAL_SUB2_IMGSENSOR = hi259ofilm_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5kgm1stofilm_mipi_raw s5k3l6ofilm_mipi_raw ov02b10ofilm_mipi_raw hi259ofilm_mipi_raw ov8856ofilm_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov02b10ofilm_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1stofilm_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3l6ofilm_mipi_raw
CUSTOM_KERNEL_SUB2_IMGSENSOR = hi259ofilm_mipi_raw
...
ifeq ($(TARGET_PRODUCT), cannon)
CUSTOM_MODEM=cannon_images
else
CUSTOM_MODEM=cannong_images
endif
ifeq (JP,$(strip $(PRODUCT_HWC)))
CUSTOM_MODEM=cannonsb_images
endif
ifneq ($(filter ro.miui.customized.region=jp, $(subst _, ,$(BUILD_MIUI_CUSTOMIZED_PROP))),)
CUSTOM_MODEM=cannonsb_images
endif
